...
public class Const {
	...
	public static final String FILEPATHVIDEO = "uploadFiles/video/";			//视频上传路径
	public static final String FILEPATHFILEOA = "uploadFiles/uploadFile/";	//文件上传路径(oa管理)
	public static final String FILEPATHTWODIMENSIONCODE = "uploadFiles/twoDimensionCode/"; //二维码存放路径
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(ueditor)|(file)|(video)).*";	//不对匹配该值的访问路径拦截（正则）
